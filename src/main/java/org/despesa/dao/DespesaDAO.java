package org.despesa.dao;

import org.despesa.db.DatabaseConnection;
import org.despesa.model.Despesa;
...
public class DespesaDAO {
    ...
    private static final String INSERT_SQL = "INSERT INTO despesas (descricao, valor, data, categoria) VALUES (?, ?, ?, ?)";
    private static final String SELECT_ALL_SQL = "SELECT * FROM despesas ORDER BY data DESC";
    private static final String UPDATE_SQL = "UPDATE despesas SET descricao = ?, valor = ?, data = ?, categoria = ? WHERE id = ?";
